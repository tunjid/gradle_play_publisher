...
public class AndroidPublisherHelper {
     ...
     */
    protected
    static AndroidPublisher init(PlayPublisherPluginExtension extension, ApplicationVariant variant)
            throws IOException, GeneralSecurityException {

        // Authorization.
        newTrustedTransport();
        Credential credential = authorizeWithServiceAccount(extension, variant);
