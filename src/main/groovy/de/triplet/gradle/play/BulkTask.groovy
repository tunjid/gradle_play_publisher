...
class BulkTask extends DefaultTask {
    ...
    static BulkTask createBulkTask(Project project, DefaultTask task, String buildType) {
...
/**
 * Removes the appended _Decorated from {@link Class#getSimpleName} for the {@link DefaultTask}
 ...
 */
    ...
    static String getBulkTaskName(DefaultTask task, String buildType) {
